...
public class client_frame extends javax.swing.JFrame 
{
    ...
    {
         ta_chat.append("you are now offline.\n");
    }
    ...
    {
        String bye = username + ":has Disconneted.:Disconnect";
        try
        {
            writer.println(bye); 
            writer.flush(); 
    ...
    public void Disconnect() 
    {
        try 
        {
            ta_chat.append("You left the conversation\n");
            sock.close();
        } catch(Exception ex) {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(b_send, javax.swing.GroupLayout.DEFAULT_SIZE, 123, Short.MAX_VALUE))
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(tf_address, javax.swing.GroupLayout.DEFAULT_SIZE, 223, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(b_connect, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(b_disconnect, javax.swing.GroupLayout.DEFAULT_SIZE, 183, Short.MAX_VALUE))))
                .addContainerGap())
        );
    ...
    private void b_sendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_sendActionPerformed
        ...
        if ((tf_chat.getText()).equals(nothing)) {
            ...
            try {
               ...
               writer.flush();
               ta_chat.append("You: "+ tf_chat.getText()+"\n");
            } catch (Exception ex) {
